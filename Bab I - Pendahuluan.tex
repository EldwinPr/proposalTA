...
\begin{enumerate}[1.]
    ...
    \item Untuk \textit{cloud comparison}, penelitian menggunakan VPS \textit{free tier} atau \textit{trial credit} dari \textit{provider} seperti Oracle Cloud Always Free atau DigitalOcean \textit{trial}, dengan spesifikasi yang \textit{comparable} dengan SBC yang diuji (contoh: 2-4 vCPU, 4GB RAM).
    ...
    \item Pengujian dibatasi pada modul esensial ERP (keuangan, inventori, CRM) dengan simulasi beban kerja yang representatif untuk UMKM skala kecil-menengah (10-50 \textit{concurrent users}).
    \item Penelitian ini mengkaji kelayakan teknis dan finansial, tidak mencakup aspek \textit{organizational readiness}, \textit{change management}, atau \textit{user training}.
