...
\begin{enumerate}[1.]
    ...
    \item Untuk \textit{cloud comparison}, penelitian menggunakan VPS dari \textit{provider} seperti DigitalOcean, Vultr, atau Linode dengan spesifikasi yang \textit{comparable} dengan SBC yang diuji (contoh: 2-4 vCPU, 4GB RAM). Penggunaan \textit{trial credit} atau \textit{free tier} dengan catatan terkait limitasi performa akan didokumentasikan untuk transparansi hasil.
