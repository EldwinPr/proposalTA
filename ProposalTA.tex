...
% ==========================================
% KONFIGURASI HYPHENATION DAN LINE BREAKING
% ==========================================
% Atur toleransi untuk menghindari overfull/underfull hbox
\tolerance=1000
\emergencystretch=3em
\hyphenpenalty=500
\exhyphenpenalty=100

% Definisikan hyphenation untuk kata-kata teknis yang sering muncul
\hyphenation{
  Enter-prise
  Re-source
  Plan-ning
...
\setlength{\emergencystretch}{2em} % jaga justifikasi tetap rapi tanpa overfull box
...
\usepackage{float} % for precise float placement control (H option)
\usepackage{listings} % for code listing
\usepackage{newfloat} % for creating custom float environments
...
% --- Buat environment custom untuk rumus ---
% --- Harus diletakkan sebelum \begin{document} ---
\DeclareFloatingEnvironment[
    fileext=loe,
    listname={DAFTAR RUMUS},
    name=Rumus,
    placement=htbp,
]{equation-float}
...
% Cegah pemenggalan yang menyisakan <=2 huruf di awal baris (mis. pembeli-an, lingkung-an,
% da-ta). Diletakkan setelah \begin{document} agar tidak ditimpa oleh babel.
\righthyphenmin=3
...
\begin{center}
    ...
    {\Large\bfseries PENERAPAN \textit{ENTERPRISE RESOURCE PLANNING} PADA \textit{SINGLE BOARD COMPUTER}}\\
     \vspace{4cm}
...
\captionsetup[equation-float]{labelsep=space}
\floatsetup[equation-float]{capposition=bottom}
