...
\begin{center}
    ...
    {\Large\bfseries PENERAPAN ENTERPRISE RESOURCE PLANNING PADA SINGLE BOARD COMPUTER DENGAN ANALISIS PERFORMA DAN TOTAL COST OF OWNERSHIP}\\
     \vspace{4cm}
...
% Format judul daftar rumus
{\centering\large\bfseries DAFTAR RUMUS\par}
\vspace{1em}
